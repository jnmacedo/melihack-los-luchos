...
$(document).ready(function () {
    ...
    $('#llquestionText').keyup(function () {
        if ($(this).val() !== "") {
            ...
            //Find keywords
            var palabrasClave = PalabrasClave.obtenerPC(string, ["hola","tenes"]); //TODO cargar stop_words desde la db
...
QuestionBox.getKeywords = function (string) {
    return string.split(" ");
};

QuestionBox.preloadData = function () {
    var pregunta1 = {};
